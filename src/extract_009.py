...
PDF_PATH = BASE_DIR / ".raw_data" / "008_화곡초등학교_대안구체화.pdf"
OUT_DIR = BASE_DIR / "data" / "extracted_009"
OUT_DIR.mkdir(parents=True, exist_ok=True)

PROJECT_ID = "hwagok_school_2024"
PROJECT_NAME = "화곡초등학교 건립공사"
SOURCE_YEAR = 2024
SOURCE_ORG = "화곡"
...
def run():
    print("=" * 60, flush=True)
    print("화곡초등학교 — 대안구체화 추출", flush=True)
    print("=" * 60, flush=True)
